...
public class TeacherAddQuestionController {
    ...
    void addQuestion(ActionEvent event) throws IOException {
        ...
        answers.remove(2);
        if (Courses.getTargetItems().isEmpty())
        ...
        else if(CorrectAnswerCB.getSelectionModel().isEmpty()||CorrectAnswerCB.getSelectionModel()==null)
        ...
        {
            System.out.println("answer number "+j+" is "+item);
            j++;
        }
        System.out.println("Subject is: "+subject.getName() );
        System.out.println("courses is: "+SelectedCourses.get(0).getName() );
